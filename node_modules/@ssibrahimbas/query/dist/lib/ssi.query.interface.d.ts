...
export interface ISsiQuery {
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    select(fields: string | Record<string, string> | Array<string> | Array<Record<string, string>>): ISsiQuery;
    /**
     *
     *
     * @param {string} fields
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    join(table: string, field1?: string | null, field2?: string | null, type?: string): ISsiQuery;
    /**
     *
     *
     * @param {string} table
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    where(where: string | Array<string>, operator?: string | Array<string> | boolean | null, val?: string | null | number, type?: string, andOr?: string): ISsiQuery;
    /**
     *
     *
     * @param {(string | Array<string>)} where
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    orWhere(where: string | Array<string>, operator?: string | Array<string> | boolean | null, val?: string | null | number): ISsiQuery;
    /**
     *
     *
     * @param {(string | Array<string>)} where
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    notWhere(where: string | Array<string>, operator?: string | Array<string> | boolean | null, val?: string | null | number): ISsiQuery;
    /**
     *
     *
     * @param {(string | Array<string>)} where
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    orNotWhere(where: string | Array<string>, operator?: string | Array<string> | boolean | null, val?: string | null | number): ISsiQuery;
    /**
     *
     *
     * @param {string} where
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    in(field: string, keys: Array<string | number>, type?: string, andOr?: string): ISsiQuery;
    /**
     *
     *
     * @param {string} field
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    findInSet(field: string, key: string | number, type?: string, andOr?: string): ISsiQuery;
    /**
     *
     *
     * @param {string} field
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    between(field: string, value1: string | number, value2: string | number, type?: string, andOr?: string): ISsiQuery;
    /**
     *
     *
     * @param {string} field
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    notBetween(field: string, value1: string | number, value2: string | number): ISsiQuery;
    /**
     *
     *
     * @param {string} field
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    orBetween(field: string, value1: string | number, value2: string | number): ISsiQuery;
    /**
     *
     *
     * @param {string} field
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    orNotBetween(field: string, value1: string | number, value2: string | number): ISsiQuery;
    /**
     *
     *
     * @param {string} field
     ...
     * @author Sami Salih İBRAHİMBAŞ
     */
    having(field: string, operator?: string | Array<string> | null, val?: string | null): ISsiQuery;
    /**
     *
     *
     * @param {string} query
